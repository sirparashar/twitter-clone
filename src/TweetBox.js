...
function TweetBox() {
  ...
  const sendTweet = (e) => {
    ...
    db.collection("posts").add({
      displayName: "Prashant Parashar",
      username: "sirparashar",
      verified: true,
      text: tweetMessage,
      image: tweetImage,
      avatar:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9syaGi5hGLH3e1XSLA5vCAVK4ZM72ptlKkQ&usqp=CAU",
    });
    setTweetMessage("");
    setTweetImage("");
  };
    ...
    <div className="tweetbox">
      <form action="">
        ...
        <input
          ...
          type="text"
          placeholder="Optinal: enter image url "
        />
